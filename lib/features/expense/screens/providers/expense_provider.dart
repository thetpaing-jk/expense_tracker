...
final expenseDateTime = StateProvider<String>((ref)=> DateFormat("MM-dd-yyyy").format(DateTime.now()));
...
typedef ExpenseNotifierProvider = NotifierProvider<ExpenseProvider, ExpenseProviderState>;
class ExpenseProvider extends Notifier<ExpenseProviderState>{
  ...
  Future<void> addExpense(ExpenseModel expense) async{
    try {
      ...
      state = ExpenseSuccessState(expenseList: expenseList, total: totalExpense, message: "Successfully created");
    } catch (e) {
      state = ExpenseErrorState(systemErrorMessage: "$e", errorMessage: "Something went Wrong");
    }
  }
  ...
  Future<void> editExpense(ExpenseModel expense) async{
    try {
      ...
      List<ExpenseModel> expenseList = await usecase.getExpenseList();
      double totalExpense = await usecase.getTotalExpense();
      state = ExpenseSuccessState(expenseList: expenseList, total: totalExpense, message: "Successfully updated");
    } catch (e) {
      state = ExpenseErrorState(systemErrorMessage: "$e", errorMessage: "Something went Wrong");
    }
  }
  ...
  Future<void> deleteExpense(int expenseId) async{
    try {
      ...
      List<ExpenseModel> expenseList = await usecase.getExpenseList();
      double totalExpense = await usecase.getTotalExpense();
      state = ExpenseSuccessState(expenseList: expenseList, total: totalExpense, message: "Successfully deleted");
    } catch (e) {
      state = ExpenseErrorState(systemErrorMessage: "$e", errorMessage: "Something went Wrong");
    }
  }
  ...
  Future<void> getAllExpense() async{
    try {
      ...
      state = ExpenseSuccessState(expenseList: expenseList, total: totalExpense);
    } catch (e) {
      state = ExpenseErrorState(errorMessage: "Something went worng", systemErrorMessage: "$e");
    }
  }
